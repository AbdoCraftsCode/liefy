...
import { confirEachOtp, createKiloPrice, createOrderClient, createOrUpdateSettings, createPaymentIntent, deleteKiloPrice, deleteMyAccount, forgetpassword,   forgetPasswordphone,   forgetPasswordphoneadmin,   getAppSettingsAdmin,   getKiloPrice,   getMyactiveOrders,   getMyCompactProfile,   getMycompletedOrders,   getMyPendingOrders,   getMyProfile,   getPendingOrdersForDelivery,   getSettings,   login, loginAdmin, loginRestaurant, loginwithGmail, refreshToken, resendOTP, resetpassword, resetPasswordphone, stripeWebhook, updateKiloPrice, updateUserLocation, verifyOTP, verifyPayment } from "./service/authontecation.service.js";
