...
import { confirEachOtp, createKiloPrice, createOrderClient, createOrUpdateSettings, deleteKiloPrice, deleteMyAccount, forgetpassword,   forgetPasswordphone,   forgetPasswordphoneadmin,   getAppSettingsAdmin,   getKiloPrice,   getMyactiveOrders,   getMyCompactProfile,   getMycompletedOrders,   getMyPendingOrders,   getMyProfile,   getSettings,   login, loginAdmin, loginRestaurant, loginwithGmail, refreshToken, resendOTP, resetpassword, resetPasswordphone, updateKiloPrice, updateUserLocation, verifyOTP } from "./service/authontecation.service.js";
