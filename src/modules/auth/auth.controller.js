...
import { addFavoritePlace, confirEachOtp, createKiloPrice, createOrderClient, createOrUpdateSettings, createPaymentIntent, deleteFavoritePlace, deleteKiloPrice, deleteMyAccount, forgetpassword,   forgetPasswordphone,   forgetPasswordphoneadmin,   getAppSettingsAdmin,   getKiloPrice,   getMyactiveOrders,   getMyCompactProfile,   getMycompletedOrders,   getMyFavoritePlaces,   getMyPendingOrders,   getMyProfile,   getPendingOrdersForDelivery,   getSettings,   login, loginAdmin, loginRestaurant, loginwithGmail, refreshToken, resendOTP, resetpassword, resetPasswordphone, stripeWebhook, updateKiloPrice, updateOrderStatusdlivery, updateUserLocation, verifyOTP, verifyPayment } from "./service/authontecation.service.js";
