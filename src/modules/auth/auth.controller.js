...
dotenv.config();
routr.post("/stripeWebhook", express.raw({ type: "application/json" }), stripeWebhook);
...
routr.patch("/updateOrderStatusdlivery/:orderId", authentication(), updateOrderStatusdlivery)
routr.delete("/deleteFavoritePlace/:favoriteId", authentication(), deleteFavoritePlace)
...
routr.post("/sendNotificationById", sendNotificationById)

routr.post("/cancelOrder/:orderId", authentication(), cancelOrder)
routr.post("/addFavoritePlace", authentication(), addFavoritePlace)

routr.post("/createComplaint", authentication(), createComplaint)

routr.post("/updateUserLanguage", authentication(), updateUserLanguage)

routr.post("/reviewDeliveryAccount", reviewDeliveryAccount)

routr.get("/getAllComplaintsadmin", getAllComplaintsadmin)

routr.get("/getMyPendingWithdrawRequestsAdmin", getMyPendingWithdrawRequestsAdmin)

routr.get("/getUserNotifications/:userId", getUserNotifications)

routr.post("/blockUser", blockUser)
routr.post("/unblockUser", unblockUser)


routr.post("/markAllNotificationsAsReadd/:userId", markAllNotificationsAsReadd)

routr.get("/getCompletedOrders", getCompletedOrders)

routr.get("/getAllComplaints", getAllComplaints)

routr.get("/getDriverPaymentsSummaryADMIN/:id", getDriverPaymentsSummaryADMIN)

routr.post("/resetSucceededPayments", authentication(), resetSucceededPayments)

routr.post("/createWithdrawRequest", authentication(), createWithdrawRequest)


routr.post("/reviewWithdrawRequest", authentication(), reviewWithdrawRequest)


routr.get("/getDeliveryHistory", authentication(), getDeliveryHistory)

routr.get("/getDriverPaymentsSummary", authentication(), getDriverPaymentsSummary)

routr.get("/getMyPendingWithdrawRequests", authentication(), getMyPendingWithdrawRequests)

routr.get("/getAllWithdrawRequests", getAllWithdrawRequests)

routr.get("/getMyActiveOrdersForDelivery", authentication(), getMyActiveOrdersForDelivery)

routr.get("/getMyFavoritePlaces", authentication(), getMyFavoritePlaces)
...
routr.post("/createPaymentIntent", authentication(), createPaymentIntent)
...
routr.get("/getMyPendingOrders", authentication(), getMyPendingOrders)

routr.get("/getMyactiveOrders", authentication(), getMyactiveOrders)
routr.get("/getMycompletedOrders", authentication(), getMycompletedOrders)
routr.get("/getPendingOrdersForDelivery", authentication(), getPendingOrdersForDelivery)

routr.delete("/deleteKiloPrice/:id", deleteKiloPrice)
routr.patch("/updateKiloPrice/:id", updateKiloPrice)

routr.get("/getKiloPrice", getKiloPrice)

routr.post("/createKiloPrice", createKiloPrice)


routr.post("/updateUserLocation", authentication(), updateUserLocation)
routr.post(
    "/createOrderClient",
    authentication(), // تحقق من التوكن
    uploadCloudFile([
